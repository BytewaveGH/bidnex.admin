  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <Input type="text" id="location" placeholder="e.g. 123 Main St, City" className="mt-1 w-full" />
              </div>
            </div>
          </div>
        </CardContent>
          ...
          {['basic', 'standard', 'premium'].map((plan, index) => (
            <Card
              ...
              className={cn(
                ...
                storagePlan === plan ? 'border-green-500 shadow-lg' : 'border-muted hover:border-green-300'
              )}
            >
              <div className="text-center font-semibold capitalize mb-2 text-lg">{plan}</div>
      ...
      <div>
        ...
        <Input placeholder="e.g. mycoolsite" value={siteName} onChange={(e) => setSiteName(e.target.value)} />
        {siteName && (
          ...
          {layoutOptions.map((layout, index) => (
            <Card
              ...
              className={cn(
                ...
                layoutStyle === layout ? 'border-blue-500 shadow-lg' : 'border-muted hover:border-blue-300'
              )}
            >
              <img
              ...
              />
              <div className="text-center font-medium capitalize">{layout.replace('-', ' ')}</div>
            </Card>
          ))}
        </div>
      </div>
