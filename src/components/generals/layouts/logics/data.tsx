...
export const sidebarItems = [
    {
      title: "Overview",
      items: [
        { label: "Dashboard", href: "/en/admin/dashboard", icon: LayoutDashboard },
      ],
    },
    {
      title: "Auctions",
    ...
    },
    {
      title: "Catalog",
      items: [
        { label: "Categories", href: "/en/admin/categories", icon: Tag },
      ],
    },
    {
      title: "Users",
      items: [
        { label: "All Users", href: "/en/admin/users", icon: Users },
      ],
    },
    {
      title: "Support",
      items: [
        { label: "Disputes", href: "/en/admin/disputes", icon: AlertCircle },
      ],
    },
  ];